package wedo.asim.odoroid.client.builder;

import android.util.Log;

import wedo.asim.odoroid.OdooClient;
import wedo.asim.odoroid.client.builder.data.OdooRecords;
import wedo.asim.odoroid.client.helper.OdooErrorException;
import wedo.asim.odoroid.client.helper.data.OdooRecord;
...
import wedo.asim.odoroid.client.listeners.IOdooRecords;
