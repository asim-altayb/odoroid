...
import wedo.asim.odoroid.OdooClient;
import wedo.asim.odoroid.OdooUser;
import wedo.asim.odoroid.R;
import wedo.asim.odoroid.client.helper.OdooErrorException;
import wedo.asim.odoroid.client.helper.OdooResponse;
import wedo.asim.odoroid.client.helper.data.OdooResult;
import wedo.asim.odoroid.client.helper.utils.OArguments;
import wedo.asim.odoroid.client.helper.utils.ODomain;
import wedo.asim.odoroid.client.helper.utils.OdooFields;
import wedo.asim.odoroid.client.helper.utils.OdooParams;
import wedo.asim.odoroid.client.helper.utils.OdooValues;
import wedo.asim.odoroid.client.helper.utils.ResponseQueue;
import wedo.asim.odoroid.client.listeners.AuthenticateListener;
import wedo.asim.odoroid.client.listeners.IOdooResponse;
import wedo.asim.odoroid.client.listeners.OdooConnectListener;
import wedo.asim.odoroid.client.listeners.OdooErrorListener;
import wedo.asim.odoroid.client.listeners.OdooVersionListener;
